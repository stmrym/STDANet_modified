...
#     --data_name=REDS_RR \
#     --phase=test \
#     --weights=$HOME/STDAN/exp_log/train/2023-10-18T155558_STDAN_Stack_REDS/checkpoints/ckpt-epoch-0400.pth.tar  
...
python runner.py \
    ...
    --phase=test \
    --weights=$HOME/STDAN/exp_log/train/2023-11-09T174600_STDAN_Stack_BSD_2ms16ms/checkpoints/ckpt-epoch-0400.pth.tar  
