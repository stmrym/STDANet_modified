...
# __C.CONST.WEIGHTS                       = 'exp_log/train/20231221_2023-12-21T185537_STDAN_Stack_BSD_3ms24ms_GOPRO/checkpoints/ckpt-epoch-0040.pth.tar' # data weights path
__C.CONST.WEIGHTS                       = ''
__C.CONST.TRAIN_BATCH_SIZE              = 2 # original: 8
...
__C.CONST.DEBUG_PREFIX                  = 'Motion_'  # This strings will be added to output_dir_path
...
__C.TRAIN.NUM_EPOCHES                   = 200   # original: 1200                   # maximum number of epoches
__C.TRAIN.LEARNING_RATE                 = 1e-4 # original: 1e-4
# __C.TRAIN.LR_MILESTONES                 = [400,600,800,1000]   
__C.TRAIN.LR_MILESTONES                 = [200]   
