...
#
__C.CONST                               = edict()
__C.CONST.CONFIG_NAME                   = 'my_config_debug'
...
__C.DATASET.TEST_DATASET_LIST           = ['BSD_3ms_24ms']       # Arbitary output name
__C.DIR.TEST_IMAGE_BLUR_PATH_LIST       = [ '../dataset/BSD_3ms24ms/%s/%s/Blur/RGB/%s.png' # %s, %s, %s: phase, seq_name, image_name
                                            ]   
__C.DIR.TEST_IMAGE_CLEAR_PATH_LIST      = [ '../dataset/BSD_3ms24ms/%s/%s/Sharp/RGB/%s.png'
                                            ]
__C.DIR.TEST_JSON_FILE_PATH_LIST        = [ '../STDAN_modified/datasets/BSD_3ms24ms_valid.json'
                                            ]
